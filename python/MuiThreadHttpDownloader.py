...
def fastDownload(url, thread=3, save_file='', buffer=1024):
...
if __name__ == '__main__':
    index=range(20,24)
    url="http://m2.music.126.net/mUMuQn6lHV0hlYBPj6he5Q==/3091826697389433.mp3"
    name='testtest.mp3'
    main(url=url, thread=5, save_file='./'+name, buffer=4096)
